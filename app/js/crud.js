...
headlessDrupal.controller('ViewLoader', function($scope, $resource) {
  var nodeService = $resource(mySite +':viewpath',
//Empty for view GET
    {},
    {
      get: {
  ...
  $scope.node = {
    'disclaimer': [{'value': 'This data is bundled into app.js, not loaded from the backend.'}],
    'title': [{'value': 'Headless Drupal + Angular.js'}],
    'body': [{'value': '<p>This demo shows how you can use a dynamic front-end (Angular.js) and a Drupal back-end to power a great user experience. Go ahead and click the n
umber field below to start loading nodes.</p>'}]
  }
